...
//////////////////////////////////////////////////////////////////////
    if (placeOne === 28) {
        updatesEl1.innerHTML = "Congrats Player One, you found a ladder!  Proceed to Space 84.";
        ladder28();
        ladderRungs28();
    }
    if (placeTwo === 28) {
        updatesEl2.innerHTML = "Congrats Player Two, you found a ladder!  Proceed to Space 84.";
        ladder28();
        ladderRungs28();
    }
    if (placeThree === 28) {
        updatesEl3.innerHTML = "Congrats Player Three, you found a ladder!  Proceed to Space 84.";
        ladder28();
        ladderRungs28();
    }
    if (placeFour === 28) {
        updatesEl4.innerHTML = "Congrats Player Four, you found a ladder!  Proceed to Space 84.";
        ladder28();
        ladderRungs28();
    }
    /////////////////////////////////////////////////////////
